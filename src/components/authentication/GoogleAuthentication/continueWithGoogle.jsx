...
export function SignInWithGoogle(){
    ...
    async function handleGoogleSignIn(user){
        let randomUserName= user.given_name+'_'+user.family_name+'_'+generateRandomNumber(0,1000);
        let userdata={
    ...
    useEffect(()=>{
        ...
        google.accounts.id.initialize({
          client_id:'31900775296-fph2smvosmqtlq3sp08da4dag05en94h.apps.googleusercontent.com',
